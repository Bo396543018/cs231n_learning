...
class CaptioningRNN(object):
  ...
  def loss(self, features, captions):
    ...
    loss, dtemporal = temporal_softmax_loss(scores, captions_out, mask)

    dh, grads['W_vocab'], grads['b_vocab'] = temporal_affine_backward(dtemporal, cache_temporal)
    if self.cell_type == 'rnn':
    ...
    dfeatrues, grads['W_proj'], grads['b_proj'] = affine_backward(dh0, cache_h0)
